               ...
               PendingIntent contentIntent = PendingIntent.getActivity(MainActivity.this,
                ...
                NotificationCompat.Builder builder =
                        new NotificationCompat.Builder(MainActivity.this, CHANNEL_ID)
                                ...
                                .setContentTitle("Долги")
                                .setContentText("Пиши работы, защищай написанные")
                                ...
                                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.dela));
                // автоматически закрыть уведомление после нажатия;
                long[] vibratePattern = {1000, 1000, 1000, 1000, 1000};
